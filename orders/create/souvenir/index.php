...
$app->get('/', function (Request $request, Response $response) use ($app){
    ...
    $orders=Orders::getSouvenirOrders($user_id);
...
$app->post('/', function(Request $request, Response $response) {
	...
	$orders=Orders::createSouvenirOrder($request->getBody());
    return $response->withJson($orders)->withHeader('Content-type', 'application/json');
});
